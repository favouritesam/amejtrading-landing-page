        ...
        <Container maxW="container.xl" py={{ base: 10, md: 16 }} mt="8%">
            ...
            <Flex direction={{ base: "column", lg: "row" }} gap={{ base: 8, lg: 10 }} align="stretch">
                ...
                <Box position="relative" w={{ base: "100%", lg: "50%" }} borderRadius="xl" overflow="visible" mt="4%">
                    <motion.div initial={{ opacity: 0, rotate: -10, scale: 0.8 }} animate={{ opacity: 1, rotate: 0, scale: 1 }} transition={{ duration: 1, ease: "easeOut" }}>
                    ...
                    >
                        ...
                        <Flex
                            ...
                            _hover={{ bg: "#0b2735" }}
                        >
                            <Link href="https://wa.me/2349050463932" target="_blank" rel="noopener noreferrer" style={{ textAlign: "center", fontWeight: "bold", fontSize: "14px" }}>
                                Enroll Now
                            </Link>
                        </Flex>
                    </Box>
