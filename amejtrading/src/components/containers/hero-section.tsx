    ...
    return (
        ...
        <Box position="relative" width="100%" minHeight="100vh" overflow="hidden">
            ...
            <Flex position="relative" zIndex={1} minHeight="100vh" align="center" justify="center" textAlign="center"
                  px={{base: 2, sm: 4, md: 6}} flexDirection="column">
                <Container maxW={{base: "container.sm", md: "container.lg"}}>
                    <motion.div initial={{opacity: 0, y: 30}} animate={{opacity: 1, y: 0}} transition={{duration: 1}}>
                        <Text fontSize={{base: "12px", sm: "16px", md: "lg"}} fontWeight="bold" color="red.500"
                              textTransform="uppercase">
                            Join Our 2-Week Expert-Led Interactive Trading Session
                        </Text>
                    </motion.div>
                    ...
                    <motion.div initial={{opacity: 0, y: 50}} animate={{opacity: 1, y: 0}}
                                transition={{duration: 1, delay: 0.3}}>
                        <Text fontSize={{base: "xl", sm: "2xl", md: "5xl"}} fontWeight="bold" color="white" mt={3}>
                            Master Forex with Expert-Led Training
                        </Text>
                    </motion.div>
                    ...
                    <motion.div initial={{opacity: 0, y: 50}} animate={{opacity: 1, y: 0}}
                                transition={{duration: 1, delay: 0.6}}>
                        <Text fontSize={{base: "xs", sm: "sm", md: "md"}} color="gray.300" mt={3}>
                            Gain hands-on experience, real-time market strategies, and risk management techniques from
                            top industry experts.
                        </Text>
                    </motion.div>
                    ...
                    <motion.div initial={{opacity: 0, y: 50}} animate={{opacity: 1, y: 0}}
                                transition={{duration: 1, delay: 0.9}}>
                        <SimpleGrid columns={{base: 1, sm: 1, md: 2}} spacingX={6} spacingY={3} mt={6}>
                            {["🚀 Live Expert Sessions", "📊 Practical Trading Simulations", "📈 Proven Strategies for Success", "📅 Daily Market Analysis", "💰 Risk Management Techniques", "🌍 Trade with Confidence"].map((text, index) => (
                                <HStack key={index}>
                                    <Icon as={FaCheckCircle} color="green.400"/>
                                    <Text fontSize={{base: "xs", sm: "sm", md: "md"}} color="white">{text}</Text>
                                </HStack>
                            ))}
                        </SimpleGrid>
                    </motion.div>
